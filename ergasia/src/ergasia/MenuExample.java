...
public class MenuExample extends JFrame implements ActionListener {
    ...
    MenuExample(){
        ...
        this.setMenuBar(this.menuBar);
        this.menuBar.add(java);
        this.java.setLabel("java");
        ...
        this.edit.setShortcut(new MenuShortcut(KeyEvent.VK_F4, false));
        this.edit.addActionListener(this);
        this.java.add(this.edit);
    ...
    public void actionPerformed (ActionEvent e){
        ...
        else if(e.getSource() == this.newFile)
		{
            ...
            try{
                list.printPersons();
                //BufferedWriter out = new BufferedWriter(new FileWriter(list.printPersons()));
                out.write(this.textArea.getText());
                out.close();
            }
            catch(Exception ex){
